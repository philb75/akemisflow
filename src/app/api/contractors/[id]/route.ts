...
export async function PUT(
  ...
  try {
    ...
    // Prepare contractor update data with environment-aware field names
    const baseContractorUpdateData = useSupabase ? {
      ...
      rate_frequency: rateFrequency || null,
    ...
    const updateData = formatContractorNames(baseContractorUpdateData)
    ...
    if (useSupabase) {
      ...
      supplier = await prisma.contractor.update({
        where: {
          id: id
        },
        data: updateData
